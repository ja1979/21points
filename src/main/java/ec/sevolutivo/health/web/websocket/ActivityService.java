package ec.sevolutivo.health.web.websocket;

import ec.sevolutivo.health.security.SecurityUtils;
import ec.sevolutivo.health.web.websocket.dto.ActivityDTO;
...
import static ec.sevolutivo.health.config.WebsocketConfiguration.IP_ADDRESS;
